...
public class WaitSendState extends AbstractState {
    ...
    public boolean sendProduct(String orderSn, Enum<Constants.OrderState> currentOrderState) {
        return orderRepository.alterState(orderSn,currentOrderState, Constants.OrderState.WAIT_SIGNATURE);
    }
    ...
    public boolean returnProduct(String orderSn, Enum<Constants.OrderState> currentOrderState) {
        return orderRepository.alterState(orderSn,currentOrderState, Constants.OrderState.PEND_REFUND);
    }
