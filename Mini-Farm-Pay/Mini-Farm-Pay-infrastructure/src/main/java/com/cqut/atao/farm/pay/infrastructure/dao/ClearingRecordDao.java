...
import com.cqut.atao.farm.pay.infrastructure.po.ClearingRecord;
 ...
 * @Description 清分数据访问层接口
 * @createTime 2023年02月23日 14:57:00
 */
public interface ClearingRecordDao extends BaseMapper<ClearingRecord> {
